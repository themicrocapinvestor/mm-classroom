...
This copy currently shows the Major Markets map over one year while the daily version is being recaptured. Even here, watch for tails that double back; on a daily chart those reversals are constant, and each would be a false alarm if treated as a fresh trend.

![The Major Markets map, weekly, over three years, the calmer view]({{ "/assets/shots/rrg-sectors-weekly.png" | relative_url }})
*Chart courtesy of StockCharts.com. RRG and Relative Rotation Graphs are registered trademarks of RRG Research.*
