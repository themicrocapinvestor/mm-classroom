...
*Chart courtesy of StockCharts.com. RRG and Relative Rotation Graphs are registered trademarks of RRG Research.*
Compare the calm of this weekly, three year view with the twitchier daily view above: the longer window smooths the tails, and a name's quadrant can differ between timeframes. Three years of tails show where each index has travelled from, not just where it sits.
