...
description: "Learn to read the trails on an RRG, the clockwise rotation pattern, and how to describe any rotation in one sentence."
module: 6
chapter: 3
permalink: /m06/c03/
---
...
![The Major Markets map over a one year range]({{ "/assets/shots/rrg-sectors-daily.png" | relative_url }})
*Chart courtesy of StockCharts.com. RRG and Relative Rotation Graphs are registered trademarks of RRG Research.*
This copy currently shows the Major Markets map over one year; the daily version is being recaptured by hand and is coming. The skill is the same on any version: find tails curling clockwise, Improving up toward Leading or Leading down toward Weakening. Those curls are rotations in progress.
...
- **Daily**: fast and twitchy. Dots dart between quadrants on ordinary noise; dangerous if you treat every wiggle as a trend.
- **Weekly**: slow and calm. A rotation that survives here is more likely a real season change, not a cloudy afternoon.
...
![The Major Markets map on the weekly RRG, three years of it]({{ "/assets/shots/rrg-sectors-weekly.png" | relative_url }})
*Chart courtesy of StockCharts.com. RRG and Relative Rotation Graphs are registered trademarks of RRG Research.*
Compare this weekly, three year view with the one year view above: the longer window smooths the tails, and quadrant positions can differ. Three years of tails show where each index has travelled from, not just where it sits.
