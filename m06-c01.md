...
description: "Learn what a benchmark is, what relative strength means, and why a stock that rises can still be losing the race."
module: 6
chapter: 1
audio: true
permalink: /m06/c01/
...
Go to [Apple's overview page on StockAnalysis](https://stockanalysis.com/stocks/aapl/?ref=MICROCAPMINUTE) and find the 1-year return. Then look up the S&P 500's 1-year return on the same site. Subtract the second from the first. If the answer is positive, Apple beat the market. Repeat for Coca-Cola (KO). Write both gaps in a notebook with today's date.
</div>
...
Read [Apple's overview page on StockAnalysis](https://stockanalysis.com/stocks/aapl/?ref=MICROCAPMINUTE). Notice how the returns are shown for several periods, and how different the story can look at 1 month versus 5 years.
