...
description: "See a finished deep dive end to end, how it is organised, what it concluded, and what it deliberately did not claim."
module: 5
chapter: 7
audio: true
permalink: /m05/c07/
...
Your second worked example exists, and it is nothing like Apple. The publisher's weekly newsletter ran the same method on Travelers, a giant US insurer, and the dive sits in the newsletter archive at [themicrocapminute.in](https://www.themicrocapminute.in/). The three checks adapt. Business quality: the website says about 30,000 employees, the signed annual report says 34,000, and the filing wins. The moat: a household switches insurer in twenty minutes, so the customer is not locked in; the 13,500 independent agents who sell the policies are. The forensic layer: receivables grew 10% while premiums grew 4%, one line moving the wrong way, printed anyway.
